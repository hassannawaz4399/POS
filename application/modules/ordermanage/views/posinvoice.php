...
text/x-generic posinvoicedirectprint.php ( ASCII C program text, with CRLF line terminators )
...
<div class="page-wrapper">
      ...
      <?php $i++;} }}?>
                ...
                <div class="row-data border-top">
                    <div class="item-info">
                        <h5 class="item-title text-bold"><?php echo display('grand_total')?>HHHAASSSAANN</h5>
                    </div>
			...
			if($orderinfo->customerpaid>0){
				$customepaid=$orderinfo->customerpaid  - $taxinfo->$fieldname;
				$changes=$customepaid-$orderinfo->totalamount - $taxinfo->$fieldname;
				}
			else{
				$customepaid=$orderinfo->totalamount - $taxinfo->$fieldname;
				$changes=0;
				}
			if($billinfo->bill_status==1){?>
                <div class="row-data">
                    ...
                    <h5 class="my-5"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo $customepaid - $taxinfo->$fieldname; ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
                <?php } else{ ?>
                <div class="row-data">
                    <div class="item-info">
            ...
            <div class="invoice_address">
                ...
                <div class="text-center">
                    ...
                    <p class="b_top"><?php echo display('')?></p>
                </div>
            </div>
        </div>
    </div>
